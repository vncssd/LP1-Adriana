...
public class EquipamentoModel {
    ...
    public EquipamentoModel(boolean recebeuManuntencao, String modelo, String marca, EquipamentoEstado equipamentoEstado) {
    ...
    public boolean buscarEquipamentoPorNome(EquipamentoModel equipamento){
